    ...
    <div class="settlement-content">
        ...
        <div class="deliver-box">
          ...
          <div class="deliver-box-bottom">
            ...
            <div class="place-detail">
              <span>详细地址:</span
              ><input type="text" v-model="receivePlaceDetail" placeholder="区/街道/小区/栋/单元" />
            </div>
          </div>
        </div>
      ...
      <div class="settlement-content-right">
        ...
        <div class="commit-button-box">
          <button
            :disabled="canButtonUse"
            class="button-box"
            @click="commitOrder()"
          >
            提交订单
            <!-- :disabled="commitOrderFlag = (this.receivePlaceValue&&this.receiveName&&this.receivePhoneNumber) || 0" -->
          </button>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    //         receiverAddress: this.receivePlaceValue.toString()+","+this.receivePlaceDetail,
    //       },
    //       {
    //         headers: {
  ...
  computed: {
    ...
    canButtonUse() {
      if (
        this.receivePlaceValue.length != 0 &&
        this.receiveName &&
        this.receivePhoneNumber &&
        this.receivePlaceDetail
      ) {
        console.log("false");
        return false;
      } else {
